...
class UmengCommonSdk {
  ...
  static Future<dynamic> initCommon(String androidAppkey, String iosAppkey, String channel, {bool logEnable = false}) async {
    List<dynamic> params = [androidAppkey, iosAppkey ,channel, logEnable];
